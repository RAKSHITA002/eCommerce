document.addEventListener('DOMContentLoaded', function () {
    let JeweleryProduct = document.querySelector(".jeweleryProducts")
    async function fetchJeweleryCategory(url) {
    ...
    fetchJeweleryCategory('https://fakestoreapi.com/products/category/jewelery');
});
